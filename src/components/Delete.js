...
const Delete = () => {
  ...
  function deleteStudent(){
    ...
    axios.delete('http://127.0.0.1:8000/api/studentdelete/'+Class+Roll).then(function(response){
          ...
          <div className="px-4 sm:pl-6  sm:pr-6 lg:pl-8 lg:pr-8">
            <div className="sm:flex  sm:items-center">
              <div className="flex-grow">
                <p className="text-gray-700  text-sm">View student's detail before deleting.</p>
                {/* <p className="text-gray-700 pt-4 text-sm">Select class and roll no of the student to display details.</p> */}
              </div>
            </div>
            ...
            {isData &&
              <div className="bg-white max-w-2xl shadow overflow-hidden sm:rounded-lg">
                ...
                <div className="mt-6 pl-6 flex items-center justify-start gap-x-6 mb-6">
               
                <button type="button" onClick={deleteStudent}  className="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">
                    Delete
                </button>
                <button type="button" onClick={()=>setFlag(false)} className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Cancel
                </button>
            </div>
              </div>
